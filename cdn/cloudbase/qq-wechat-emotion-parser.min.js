...
function qqWechatEmotionParser(str){var indices=trie.search(str);indices.reverse().map(function(idx){var pos=idx[0],emotion=emotion_list[idx[1]],img='<img src="'+emotion_map[emotion]+'" class="lazy" data-srcset="'+emotion_map[emotion]+'" srcset="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABAQMAAAAl21bKAAAABlBMVEXMzMyWlpYU2uzLAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAACklEQVQImWNgAAAAAgAB9HFkpgAAAABJRU5ErkJggg==" alt="'+emotion+'">';str=splice(str,pos,emotion.length,img);});return str;}
...
return list;}}();<link rel="stylesheet" href="/css/spoiler.css" type="text/css"><script src="/js/spoiler.js" type="text/javascript" async></script>